<?php
require_once('Controlador/retiro.php');
$error = '';
...
if(!empty($_POST['retiro'])){
    ...
    if(strlen(trim($monto)) > 1 && strlen(trim($metodo)) > 1){
        $error = retiro($monto,$_SESSION['id_cuenta'],$_SESSION['id_usuario'],$metodo);
    }else{
...
<body>
    ...
    <article>
        <section class="info">
            <form method="post" name="deposito" action="vis.retiro.php">
                ...
                <div class="boton">
                    <input class="btn" type="submit" name="retiro" value="Retirar">
                </div>
